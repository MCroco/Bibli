...
/**
 * Cette classes sert à gerer les réponses pour la fenêtre de Mise à jour Animal ;
 * La fenêtre apparait une fois que le bouton "MAJ" est appuyé sur la fenêtre qui affiche les animaux.
 * @author 
 */
